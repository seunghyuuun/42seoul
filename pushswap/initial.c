...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/30 14:30:16 by seunghy2          #+#    #+#             */
/*   Updated: 2023/06/30 14:55:03 by seunghy2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	piececheck(char *str)
{
	...
	if (size > 10)
		return (0);
	else if (size == 10 && str[0] == '-' && \
			ft_strncmp(temp, "2147483648", size) > 0)
		return (0);
	else if (size == 10 && str[0] != '-' && \
			ft_strncmp(temp, "2147483647", size) > 0)
		return (0);
	return (1);
}
